	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			require("project_nvim").setup({
				...
				patterns = { ".git" }, -- Recherche des répertoires contenant un .git
			})
			-- [[ Configure Telescope ]]
			...
			require("telescope").setup({
				...
				defaults = {
					file_ignore_patterns = {
						"node_modules", -- Exemple d'exclusion d'un répertoire
						".git/", -- Exclure les dossiers .git
						"Library/", -- Exclure les répertoires système de macOS
						"Applications/",
						"Caches/",
					},
					-- Utilisation d'une commande rapide comme rg (ripgrep) si disponible
					vimgrep_arguments = {
						"rg",
						"--hidden",
						"--ignore",
